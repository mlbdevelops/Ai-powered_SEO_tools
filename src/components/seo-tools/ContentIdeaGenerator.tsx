...
const ContentIdeaGenerator: React.FC = () => {
  ...
  const generateContentIdeas = async () => {
    ...
    try {
      const prompt = `Generate 10 SEO-optimized ${contentType} title ideas about "${topic}"${industry ? ` in the ${industry} industry` : ''}. 

      For each idea, provide:
      1. A compelling, SEO-friendly title
      2. A 4-5 point outline
      3. Search intent (Informational, Commercial, Navigational, or Transactional)
      4. Content difficulty (Easy, Medium, or Hard)
